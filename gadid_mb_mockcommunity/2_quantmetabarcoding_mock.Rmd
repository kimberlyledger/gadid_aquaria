---
title: "Quantitative metabarcoding of mock community samples"
author:"Kimberly Ledger"
date: "2023-10-09"
output: github_document
---

this code is using the gblock mock communities from the 20230216 miseq run.  
...
```{r}
#going to test all mock communities as unknowns 
env <- mockcom_data %>%  
  filter(community %in% c("middle", "north1", "north2", "south1", "south2")) %>%  
...
```{r}
#save(Output,file=paste0("quant_outputs/raw_20231016_even",".Rdata"))
```
...
```{r}
#save(Output,file=paste0("quant_outputs/mock_20231016_even",".Rdata"))
```
