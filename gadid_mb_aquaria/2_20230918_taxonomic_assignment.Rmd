...
```{r}
decontam_reads <- read.csv("/home/kimberly.ledger/gadid_aquaria/gadid_mb_aquaria/20230918_decontamination_output_20240313.csv") %>%
...
```{r}
decontam_asvs[43,] <- c("ASV19", "Gadus macrocephalus", "species")
decontam_asvs[44,] <- c("ASV20", "Gadus chalcogrammus", "species")
decontam_asvs[45,] <- c("ASV27", "Gadus chalcogrammus", "species")
```
...
```{r}
#write.csv(join, "20230918_taxon_reads.csv")
```
