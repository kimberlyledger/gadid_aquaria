...
temp.df <- occu_df_subset
  ...
  #write_rds(myHierarchicalStanResults, "20230921_MiSeqrun_occupancy_output_20231030.rds")
```


```{r}
myHierarchicalStanResults <- read_rds("20230921_MiSeqrun_occupancy_output_20231030.rds")
...
```{r}
#write.csv(asv_table_filter4, "20230921_decontamination_output_20231030.csv", row.names = FALSE)
```
